public class UnderGraduateStudentAccount extends StudentAccount{
    private double stationaryLoan;
    private double stationaryLoanInterest;    
   
    public UnderGraduateStudentAccount(String name, String program, int currentYear, String accountNumber){
